...
function addMessage(data) {
  ...
  <span class="user_name user_name_date">
    ...
    <span class="message_hour">${dayjs(data.message.createdAt).format('DD [de] MMMM [ás] HH:mm')}</span></span>
    <div class="messages">
      <span class="chat_message">${data.message.text}</span>
    </div>
  `

  const messagesInDiv = document.querySelectorAll('div.messages')
  const lastMessage = messagesInDiv[messagesInDiv.length - 1]
